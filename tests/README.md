...
| `scientific/` | Synthetic ground truth for implemented science. Currently: correspondence verification and registration warps against declared generating models. Control-point spatial tests live in unit tests. Not official SIH evidence | Scientific for the synthetic model only |
