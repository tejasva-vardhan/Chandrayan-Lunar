...
| `scientific/` | Synthetic ground truth for implemented science. Currently: correspondence verification against declared generating models. Not official SIH evidence | Scientific for the synthetic model only |
